...
import {requestMachinedialysis} from '../../actions';
...
export default function Machinedialysis() {
  ...
  const [initialDrainage, setInitialDrainage] = useState(''); //배액량
          ...
          <View style={{justifyContent: 'center', marginLeft: 20}}>
            ...
            <View style={DialysisScreenStyle.basicView}>
              ...
              <TextInput
                style={DialysisScreenStyle.basicTextInput}
                keyboardType="numeric"
                value={String(initialDrainage)}
                onChangeText={(value) => setInitialDrainage(value)}
              />
              <Text>g</Text>
            </View>
